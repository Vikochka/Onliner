...
public class CatalogPage extends BasePage {
    ...
    private static final String LIST_TITLE_XPATH = "//a[@class='catalog-navigation-list__dropdown-item'] //..//..//..//../div[@class='catalog-navigation-list__aside-item']/div[@class='catalog-navigation-list__aside-title'][contains(text(),'%s')]";
